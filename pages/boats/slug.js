...
const Index = () => {
    ...
    const text = {
        ...
        description: 'В вашем распоряжении скоростной, вместительный катер, оборудованный комфортным тентом для любой погоды.',
        price: '12 000',
        capacityPerson: '12',
    }
        ...
        <>
            <section>
                <div className="flex flex-wrap">
                    ...
                    <ItemText tag={text.tag} title={text.title} description={text.description} price={text.price} capacityPerson={text.capacityPerson} />
                </div>
            </section>
            <section>
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <p className="text-4xl font-extrabold font-montserrat py-6 sm:pt-12 sm:pb-10">Описание</p>
