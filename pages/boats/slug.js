            ...
            <section className="flex flex-wrap">
                ...
                <div className="w-full pt-10 lg:w-1/2">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-lg lg:mx-0">
                        <span className="bg-blue-500 rounded-r-full py-1 pl-2 pr-4 text-white">Базовая коллекция</span>
                        <h1 className="text-4xl font-extrabold font-montserrat mt-4 mb-4">Черная футболка regular</h1>
                        <p className="mb-6">Футболка классического кроя из 100% хлопка. Логотип Тинькофф на груди выполнен из прорезиненного материала для долговечной носки.</p>
                        <p className="text-4xl font-extrabold font-montserrat mb-4">1 990 ₽</p>
